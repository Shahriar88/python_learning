...
#SBATCH --job-name=three_experiments
...
# Meaning:
#   -N 1              = use 1 node
#   -n 3              = run 3 Slurm tasks/processes
#   --gres=gpu:3      = request 3 GPUs total
...
if [ -z "$PY_SCRIPT_1" ] || [ -z "$PY_SCRIPT_2" ] || [ -z "$PY_SCRIPT_3" ]; then
    echo "ERROR: Three Python scripts are required."
    echo "Usage: sbatch tacc_3jobs.sh script1.py script2.py script3.py"
    exit 1
fi
...
echo "Python script 3: $PY_SCRIPT_3"
echo
...
# ============================================================
# Start three independent experiments
# ============================================================

echo "===== START THREE EXPERIMENTS ====="
...
srun --exclusive -n 1 --gres=gpu:1 bash -c "
    ...
    nvidia-smi
    python '$PY_SCRIPT_3'
" > "logs/${SLURM_JOB_NAME}_task3_${SLURM_JOB_ID}.out" 2> "logs/${SLURM_JOB_NAME}_task3_${SLURM_JOB_ID}.err" &

PID3=$!


# ============================================================
# Wait for all three experiments
# ============================================================
...
echo
echo "===== FINISHED THREE EXPERIMENTS ====="
echo "End time: $(date)"
echo "Task 1 exit status: $STATUS1"
echo "Task 2 exit status: $STATUS2"
echo "Task 3 exit status: $STATUS3"
